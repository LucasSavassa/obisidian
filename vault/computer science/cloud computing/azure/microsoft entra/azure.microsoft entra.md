![[Pasted image 20260113164823.png]]
- its a family of products that provide auth services
- like: boilerplate self-service user interface
...
- **permission**: badges needed to provide or prohibit access to users
- **user flow** : endpoints for authentication use cases
